...
// 
//
// Related Topics 数组 二分查找 👍 1153 👎 0

package leetcode.editor.cn;

/**
 * @Description 寻找旋转排序数组中的最小值
 * @Date 2024-09-11 13:01:23
 */
...
// leetcode submit region begin(Prohibit modification and deletion)
    ...
    /**
     * 二分查找：把中间的值和nums[0]比较，如果nums[mid]<nums[right]说明[mid，right]有序，那就在左半部分了，right = mid;
     * 否则在左半部分 left=mid+1, 循环条件left<right
     */
    class Solution {
